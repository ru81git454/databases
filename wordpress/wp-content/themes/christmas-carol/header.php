...
function SnowStorm() {
  ...
  var usePNG = true;
  var imagePath = '<?php bloginfo('template_url'); ?>/images/snow/'; // relative path to snow images
  var flakeTypes = 6;
  var flakesMax = 128;
...
function PNGHandler() {
  ...
  this.filterMethod = function(o) {
    ...
    if (o.nodeName != 'IMG') {
      ...
      // apply filter
      o.src = '<?php bloginfo('template_url'); ?>/images/none.gif'; // get rid of image
      o.style.filter = "progid:"+self.filterID+"(src='"+newSrc+"',sizingMethod="+(o.className.indexOf('scale')+1?'scale':'crop')+"')";
      o.style.writingMode = 'lr-tb'; // Has to be applied so filter "has layout" and is displayed. Seriously. Refer to http://msdn.microsoft.com/workshop/author/filter/reference/filters/alphaimageloader.asp?frame=true
    }
  }
...
<!-- Home Right Navi START -->
	<div id="box2a">
	  <table width="990" height="335" border="0" cellpadding="0" cellspacing="0" class="box2b">
        <tr>
          <td width="459" height="220" align="left" valign="top">
		  <a href="<?php bloginfo('url'); ?>/"><img src="<?php bloginfo('template_url'); ?>/images/0.gif" alt="Home" width="450" height="210" border="0" /></a>
		  </td>
          <td width="531" height="220" align="left" valign="top">
		  <div class="box2c">
		  <strong>Subscribe</strong>: <a href="<?php bloginfo('rss2_url'); ?>">RSS</a> | <a href="<?php bloginfo('comments_rss2_url'); ?>">Comment</a>
		  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		  <strong>Snow</strong>: <a href="javascript:snowStorm.stop()">Toggle</a> | <a href="javascript:snowStorm.randomizeWind()">Change Wind</a>
		  </div>
		  <div class="box2d">
		  <?php include (TEMPLATEPATH . "/template/468x60-ads.php"); ?>
		  </div>
		  </td>
        </tr>
        <tr>
          <td colspan="2" height="115" align="left" valign="top" class="box2e">
		<ul>
		<li style="border-right:none; border-left:none;"><img src="<?php bloginfo('template_url'); ?>/images/0.gif" width="25" height="1" alt="<?php include (TEMPLATEPATH . "/template/alt.php"); ?>" /></li>
		<li style="border-left:none;"><a href="<?php bloginfo('url'); ?>/">首頁</a></li>
		<?php wp_list_pages('title_li=0&depth=1'); ?>
		<li style="border-right:none;"><img src="<?php bloginfo('template_url'); ?>/images/0.gif" width="1" height="37" alt="<?php include (TEMPLATEPATH . "/template/alt.php"); ?>" /></li>
		</ul>
		 </td>
        </tr>
      </table>
...
<!-- Grid for content and sidebar START -->
	<div id="box3a">
		<table width="990" border="0" cellspacing="0" cellpadding="0"><tr><td width="20">&nbsp;</td><td width="626" align="left" valign="top">
